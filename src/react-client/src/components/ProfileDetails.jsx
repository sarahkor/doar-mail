...
function ProfileDetails({ user, isOpen, onClose }) {
    ...
    console.log('ProfileDetails - Full user object:', user);
    console.log('ProfileDetails - Birthday value:', user.birthday);
    console.log('ProfileDetails - Birthday type:', typeof user.birthday);
    ...
    const getProfileImageUrl = (user) => {
        ...
        if (user && user.firstName) {
            return `https://ui-avatars.com/api/?name=${encodeURIComponent(user.firstName || '')}+${encodeURIComponent(user.lastName || '')}&background=1a73e8&color=fff&size=120`;
        }
        return `https://ui-avatars.com/api/?name=User&background=1a73e8&color=fff&size=120`;
    };
                ...
                <div className="profile-details-content">
                    <div className="profile-details-avatar">
                        <img
                            ...
                            alt="Profile"
                            onError={(e) => {
                                e.target.src = `https://ui-avatars.com/api/?name=User&background=1a73e8&color=fff&size=120`;
                            }}
                        />
                    </div>
